# HTML_CSS_JS
Exercise in HTML, CSS and JavaScript (JQuery as well). Intended for those who either might be learning these or would just like to have several examples in a single page.
